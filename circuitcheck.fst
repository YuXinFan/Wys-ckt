...
if_branch = if bool_conditions then C
if_then_branch = if bool_conditions then C1 else C2

bool_conditions = bool_condition | bool_conditions bool_op bool_condition
bool_condition = 
bool_op = and | or

equality_op = > | < | = 

arith_expr = val arith_op val
arith_op = + | - | * | /
